...
#ifndef ENUM_STRINGIFYER_HPP_
#define ENUM_STRINGIFYER_HPP_
...
namespace enum_stringifyer
{
    ...
    constexpr auto enum_value_name() noexcept
    {
        ...
        constexpr std::string_view header = "auto enum_stringifyer::enum_value_name() [V = ";
...
{                                                                                          \
    ...
    using mapper = ::enum_stringifyer::EnumMapperRange<Enum, min_value, max_value>;        \
    if (::enum_stringifyer::to_underlying(v) < mapper::start ||                            \
        ::enum_stringifyer::to_underlying(v) > mapper::end)                                \
    {                                                                                      \
        return os << '(' << #Enum << ')' << static_cast<int>(v);                           \
    }                                                                                      \
    return os << mapper::mapping[::enum_stringifyer::to_underlying(v) - mapper::start];    \
...
::std::ostream& operator <<(::std::ostream& os, const Enum v)                             \
{                                                                                         \
    static constexpr auto mapper = ::enum_stringifyer::GetNamedEnum<Enum, __VA_ARGS__>(); \
